...
<div class="w-full m-0 p-0 bg-cover bg-bottom">
			<div class="max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal">
				<!--Title-->
					<h4 class="font-extrabold text-green">
					    GhbB Urs <br>[Guest house Bulletin board YOURS]
 					</h4>
                    <img src="{{ asset('images/cafe-2153865_640.jpg') }}" class="bg-cover mt-8 md:container md:mx-auto">
			</div>
		</div>
     </div>
        <!-- Email Address -->
        ...
        <br>
            ...
            <x-input-error :messages="$errors->get('email')" class="mt-7" />
        </div>
